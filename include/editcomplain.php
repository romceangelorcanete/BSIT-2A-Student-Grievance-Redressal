...
if($_POST['modify_complain'] == "Cancel") {
    ...
    $sql2 = "INSERT INTO `updates`(`trackingID`, `status`, `updates`, `updated_by`, `last_update`) VALUES
             ('$trackID', '$status', '$status', '$email', CURRENT_TIMESTAMP)";
    ...
    if($result) { 
        ...
        echo "<script type='text/javascript'> document.location ='/cpy1/track_complain.php'; </script>";
    } else {    
...
elseif($_POST['modify_complain'] == "Save") {
    ...
    $sql2 = "INSERT INTO `updates`(`trackingID`, `status`, `updates`, `updated_by`, `last_update`) VALUES
             ('$trackID', '$status', 'Details Updated', '$email', CURRENT_TIMESTAMP)";
