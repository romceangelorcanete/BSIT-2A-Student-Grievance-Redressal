...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <title>Track My Grievance</title>
</head>
<body>
    ...
    <!------------------- Complain form -------------------------->
       <div class="complain-container" id="complain">
        <form action="include/track.php" method="post">
            <div class="top">
                <header>Track My Grievance</header>
            </div>
            <div class="input-box">
                <input class="input-field" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Tracking ID.." title="Enter Tracking ID">
            ...
            <table id="myTable">
                <tr class="header">
                    ...
                    <th style="width:10%;text-align:center;">Updates</th>
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT * FROM complains WHERE `email`='$email' order by last_update desc";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td class=\"trackID\"><a href='modify_complain.php' onclick=\"modify()\">" . $row['trackingID'] . "</a></td>";
                                echo "<td style=\"text-align:center;\"><a href='view_solution.php' onclick=\"view()\">View</a></td>";
